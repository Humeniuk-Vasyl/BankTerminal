...
inline Diploma::ChangingForm::ChangingForm(void)
{
	InitializeComponent();
}
...
inline Diploma::ChangingForm::~ChangingForm()
{
	if (components)
	{
		delete components;
...
inline void Diploma::ChangingForm::InitializeComponent(void)
{
...
inline System::Void Diploma::ChangingForm::ChangePIN_codeButton_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	try {
		PIN_CodeType = Convert::ToInt32(NewPINTxt->TextName);
		RePIN_CodeType = Convert::ToInt32(ReNewPINTxt->TextName);
	}
...
inline System::Void Diploma::ChangingForm::ChangePhoneNumberButton_Click(System::Object^ sender, System::EventArgs^ e) {
	Int64 Phone_Type, RePhone_Type; // 64 bit number for the Phone
	//try-catch block for catch incorect Phone-number type 
	try {
	...
	{
		//using the UpdatePhoneNumber func, close this form n end form

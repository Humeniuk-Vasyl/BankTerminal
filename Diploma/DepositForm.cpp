...
inline Diploma::DepositForm::DepositForm(void)
{
	InitializeComponent();
}
...
inline Diploma::DepositForm::~DepositForm()
{
	if (components)
	{
		delete components;
...
inline void Diploma::DepositForm::InitializeComponent(void)
{
	...
	this->exitToolStripMenuItem->Click += gcnew System::EventHandler(this, &DepositForm::exitToolStripMenuItem_Click);
	// 
	...
	this->aboutToolStripMenuItem->Click += gcnew System::EventHandler(this, &DepositForm::aboutToolStripMenuItem_Click);
	// 
	// panel1
	// 
...
inline System::Void Diploma::DepositForm::DepositForm_Load(System::Object^ sender, System::EventArgs^ e) {
	ClientCardNumber->TextName = n->CardNumber;
}
inline System::Void Diploma::DepositForm::label3_Click(System::Object^ sender, System::EventArgs^ e) {
	exit(0);
}
inline System::Void Diploma::DepositForm::label3_MouseMove(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
	this->label3->ForeColor = System::Drawing::Color::Tomato;
}
inline System::Void Diploma::DepositForm::label3_MouseLeave(System::Object^ sender, System::EventArgs^ e) {
	this->label3->ForeColor = System::Drawing::Color::Gainsboro;
}
inline System::Void Diploma::DepositForm::mainMenuToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	this->Close();
}
inline System::Void Diploma::DepositForm::exitToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	exit(0);
}
inline System::Void Diploma::DepositForm::aboutToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	MessageBox::Show("This is Deposit Form.\nU can choose term and summ of deposit.\nGood luck.");
}
inline System::Void Diploma::DepositForm::MinusTerm_Click(System::Object^ sender, System::EventArgs^ e) {
...
inline System::Void Diploma::DepositForm::PlusTerm_Click(System::Object^ sender, System::EventArgs^ e) {
...
inline System::Void Diploma::DepositForm::DepositButton_Click(System::Object^ sender, System::EventArgs^ e) {
	int SummTxt;
	try {

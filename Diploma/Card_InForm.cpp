...
inline Diploma::Card_InForm::Card_InForm(void)
{
	InitializeComponent();
}
...
inline Diploma::Card_InForm::~Card_InForm()
{
	if (components)
	{
		delete components;
...
inline void Diploma::Card_InForm::InitializeComponent(void)
{
	this->components = (gcnew System::ComponentModel::Container());
	System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Card_InForm::typeid));
	...
	this->aboutToolStripMenuItem->Click += gcnew System::EventHandler(this, &Card_InForm::aboutToolStripMenuItem_Click);
	// 
	// panel1
	// 
	...
	this->Button50->Location = System::Drawing::Point(375, 149);
	...
	this->Button100->Location = System::Drawing::Point(529, 149);
	...
	this->Button200->Location = System::Drawing::Point(375, 271);
	...
	this->Button500->Location = System::Drawing::Point(529, 271);
	...
	this->Button1000->Location = System::Drawing::Point(375, 392);
	...
	this->Button2000->Location = System::Drawing::Point(529, 392);
	...
	this->ReplanishButton->Location = System::Drawing::Point(375, 514);
...
inline System::Void Diploma::Card_InForm::Card_InForm_Load(System::Object^ sender, System::EventArgs^ e) {
	// Transfer user-data to form columns
...
inline System::Void Diploma::Card_InForm::label3_Click(System::Object^ sender, System::EventArgs^ e) {
	exit(0);
}
inline System::Void Diploma::Card_InForm::label3_MouseMove(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
	this->label3->ForeColor = System::Drawing::Color::Tomato;
}
inline System::Void Diploma::Card_InForm::label3_MouseLeave(System::Object^ sender, System::EventArgs^ e) {
	this->label3->ForeColor = System::Drawing::Color::Gainsboro;
}
inline System::Void Diploma::Card_InForm::mainMenuToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	this->Close();
}
inline System::Void Diploma::Card_InForm::exitToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	exit(0);
}
...
inline System::Void Diploma::Card_InForm::ReplanishButton_Click(System::Object^ sender, System::EventArgs^ e) {
	int SummTxt;
	//using try-catch block to identify correct summ of replanishment
	try {
...
inline System::Void Diploma::Card_InForm::Button50_Click(System::Object^ sender, System::EventArgs^ e) {
	f2.UpdateBalance(n, 50);
	this->Hide();
	EndForm^ _EndForm1 = gcnew EndForm();
	_EndForm1->ShowDialog();
}
inline System::Void Diploma::Card_InForm::Button100_Click(System::Object^ sender, System::EventArgs^ e) {
	f2.UpdateBalance(n, 100);
	this->Hide();
	EndForm^ _EndForm1 = gcnew EndForm();
	_EndForm1->ShowDialog();
}
inline System::Void Diploma::Card_InForm::Button200_Click(System::Object^ sender, System::EventArgs^ e) {
	f2.UpdateBalance(n, 200);
	this->Hide();
	EndForm^ _EndForm1 = gcnew EndForm();
	_EndForm1->ShowDialog();
}
inline System::Void Diploma::Card_InForm::Button500_Click(System::Object^ sender, System::EventArgs^ e) {
	f2.UpdateBalance(n, 500);
	this->Hide();
	EndForm^ _EndForm1 = gcnew EndForm();
	_EndForm1->ShowDialog();
}
inline System::Void Diploma::Card_InForm::Button1000_Click(System::Object^ sender, System::EventArgs^ e) {
	f2.UpdateBalance(n, 1000);
	this->Hide();
	EndForm^ _EndForm1 = gcnew EndForm();
	_EndForm1->ShowDialog();
}
inline System::Void Diploma::Card_InForm::Button2000_Click(System::Object^ sender, System::EventArgs^ e) {

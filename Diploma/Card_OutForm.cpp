...
inline Diploma::Card_OutForm::Card_OutForm(void)
{
	InitializeComponent();
}

inline Diploma::Card_OutForm::~Card_OutForm()
{
	if (components)
	{
		delete components;
...
inline void Diploma::Card_OutForm::InitializeComponent(void)
{
	...
	this->aboutToolStripMenuItem->Click += gcnew System::EventHandler(this, &Card_OutForm::aboutToolStripMenuItem_Click);
	// 
	// label3
	// 
...
inline System::Void Diploma::Card_OutForm::label3_Click(System::Object^ sender, System::EventArgs^ e) {
	exit(0);
}
inline System::Void Diploma::Card_OutForm::label3_MouseMove(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
	this->label3->ForeColor = System::Drawing::Color::Tomato;
}
inline System::Void Diploma::Card_OutForm::label3_MouseLeave(System::Object^ sender, System::EventArgs^ e) {
	this->label3->ForeColor = System::Drawing::Color::Gainsboro;
}
inline System::Void Diploma::Card_OutForm::mainMenuToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	this->Close();
}
inline System::Void Diploma::Card_OutForm::exitToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	exit(0);
}
inline System::Void Diploma::Card_OutForm::aboutToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	MessageBox::Show("This is Withdrowal card form.\nU can choose your own number of withdrowal or select some buttons.\nGood luck.");
}
inline System::Void Diploma::Card_OutForm::Card_OutForm_Load(System::Object^ sender, System::EventArgs^ e) {
...
inline System::Void Diploma::Card_OutForm::WithdrowalButton_Click(System::Object^ sender, System::EventArgs^ e) {
	int SummTxt;
	try {
...
inline System::Void Diploma::Card_OutForm::Button50_Click(System::Object^ sender, System::EventArgs^ e) {
	int SummTxt1 = 50;
...
inline System::Void Diploma::Card_OutForm::Button100_Click(System::Object^ sender, System::EventArgs^ e) {
	int SummTxt1 = 100;
	if (SummTxt1 > Convert::ToInt32(n->Balance)) {
		MessageBox::Show("Not enought money on balance");
	}
...
inline System::Void Diploma::Card_OutForm::Button200_Click(System::Object^ sender, System::EventArgs^ e) {
	int SummTxt1 = 200;
	if (SummTxt1 > Convert::ToInt32(n->Balance)) {
		MessageBox::Show("Not enought money on balance");
	}
...
inline System::Void Diploma::Card_OutForm::Button500_Click(System::Object^ sender, System::EventArgs^ e) {
	int SummTxt1 = 500;
	if (SummTxt1 > Convert::ToInt32(n->Balance)) {
		MessageBox::Show("Not enought money on balance");
	}
...
inline System::Void Diploma::Card_OutForm::Button1000_Click(System::Object^ sender, System::EventArgs^ e) {
	int SummTxt1 = 1000;
	if (SummTxt1 > Convert::ToInt32(n->Balance)) {
		MessageBox::Show("Not enought money on balance");
	}
...
inline System::Void Diploma::Card_OutForm::Button2000_Click(System::Object^ sender, System::EventArgs^ e) {
	int SummTxt1 = 2000;
	if (SummTxt1 > Convert::ToInt32(n->Balance)) {
		MessageBox::Show("Not enought money on balance");
	}
